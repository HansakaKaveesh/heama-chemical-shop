      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {products.map((p, i) => (
            <div
              key={i}
              className="p-8 bg-white bg-opacity-90 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-500 transform hover:-translate-y-3 hover:scale-105"
            >
              <div
              ...
              <button
                type="button"
                className="cursor-pointer px-6 py-2 bg-blue-600 text-white rounded-full font-semibold
