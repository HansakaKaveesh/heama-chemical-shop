  ...
  return (
    <main className="relative bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-20">
        {/* Cosmetics */}
        <h3 id="cosmetics" className="text-xl font-semibold mb-8 text-black flex items-center gap-2">
        ...
        {/* Cleaning Essentials */}
        <h3 id="cleaning" className="text-xl font-semibold mb-8 mt-4 text-black flex items-center gap-2">
